...
class ScrollViewBottomBackgroundLayoutSpec: QuickSpec {

    override func spec() {
        describe("ScrollViewBottomBackgroundLayout") {
            var sut: ScrollViewBottomBackgroundLayout!

            beforeEach {
                sut = ScrollViewBottomBackgroundLayout()
            }
                ...
                describe("with huge content and some insets") {
                    ...
                    describe("scrolled to top") {
                        ...
                        context("when updating layout") {
                            ...
                            it("should view have correct frame") {
                                expect(view.frame) == CGRect(x: 0, y: 300, width: 100, height: 0)
                            }
                        }
                    }
                    ...
                    describe("scrolled to bottom") {
                        ...
                        context("when updating layout") {
                            ...
                            it("should view have correct frame") {
                                expect(view.frame) == CGRect(x: 0, y: 300, width: 100, height: 50)
                            }
                        }
                    }

                    describe("scrolled bellow bottom") {
                        beforeEach {
                        ...
                        context("when updating layout") {
                            ...
                            it("should view have correct frame") {
                                expect(view.frame) == CGRect(x: 0, y: 300, width: 100, height: 100)
                            }
                        }
                    }
                }

                describe("with small content and some insets") {
                    beforeEach {
                    ...
                    describe("scrolled to top") {
                        ...
                        context("when updating layout") {
                            ...
                            it("should view have correct frame") {
                                expect(view.frame) == CGRect(x: 0, y: 50, width: 100, height: 100)
                            }
                        }
                    }
